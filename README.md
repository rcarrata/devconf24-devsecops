...
- [Demo 1 - Installing DevSecOps tooling with GitOps in ARO](./demo1/README.md)
- [Demo 2 - Using StackRox to Check Vulnerabilities of container images](./demo2/README.md)
- [Demo 3 - Using Cosign to Check vulnerability in Container Images](./demo3/README.md)
- [Demo 4 - DevSecOps Image Signature Verification Pipeline](./demo4/README.md)
- [Demo 5 -  Hacking Tekton Pipeline with unsigned Container Images](./demo4/README.md)
...
- [Philipp Bergsmann](https://github.com/phbergsmann)
